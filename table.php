...
<body>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="quantity" placeholder="Insert the Amount of Product" min="0">
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="editquantity" placeholder="Insert the Amount of Product" min="0">
                    </div>
                    <div class="form-group">
    ...
    <div class="container my-3">
        ...
        <button type="button" class="btn btn-info my-4" data-toggle="modal" data-target="#productmodal"> Add Product </button>
